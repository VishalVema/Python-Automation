...
for symbol in message:
    if symbol in LETTERS:
        ...
        if mode ==  'encrypt':
            ...
            num = num - key
        if num >= len(LETTERS):
            num = num - len(LETTERS) # this is used when the value exceed the index  obtained by adding 13 (encrypting) to the values found in message variable a.k.a symbol
